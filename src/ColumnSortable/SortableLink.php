...
namespace VictorBondaruk\ColumnSortable;

use VictorBondaruk\ColumnSortable\Exceptions\ColumnSortableException;
use Illuminate\Contracts\Support\Htmlable;
use Illuminate\Support\Str;

/**
 * Class SortableLink
 * @package VictorBondaruk\ColumnSortable
 */
class SortableLink
{
     ...
     *
     * @return string
     * @throws \VictorBondaruk\ColumnSortable\Exceptions\ColumnSortableException
     */
