...
[![Latest Version](https://img.shields.io/github/release/VictorBondaruk/column-sortable.svg?style=flat-square)](https://github.com/VictorBondaruk/column-sortable/releases)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Total Downloads](https://img.shields.io/packagist/dt/VictorBondaruk/column-sortable.svg?style=flat-square)](https://packagist.org/packages/VictorBondaruk/column-sortable)
![run-tests](https://github.com/VictorBondaruk/column-sortable/workflows/run-tests/badge.svg)

Package for handling column sorting in Laravel 5.[5-8]. For earlier versions of Laravel checkout branch [L5.1-3](https://github.com/VictorBondaruk/column-sortable/tree/L5.1-3)
...
{
    "require": {
        "victorbondaruk/column-sortable": "^6.0"
    }
}
```
...
'providers' => [
     ...
     */
    VictorBondaruk\ColumnSortable\ColumnSortableServiceProvider::class,
],
```
...
```sh
php artisan vendor:publish --provider="VictorBondaruk\ColumnSortable\ColumnSortableServiceProvider" --tag="config"
```

See configuration file [(`config/columnsortable.php`)](https://github.com/VictorBondaruk/column-sortable/blob/master/src/config/columnsortable.php) yourself and make adjustments as you wish.
...
```php
use VictorBondaruk\ColumnSortable\Sortable;
...
Rest of the [config file](https://github.com/VictorBondaruk/column-sortable/blob/master/src/config/columnsortable.php) should be crystal clear and I advise you to skim it.
...
Change the suffix class in the [config file](https://github.com/VictorBondaruk/column-sortable/blob/master/src/config/columnsortable.php) from `-asc`/`-desc` (FA 4) to `-up`/`-down` (FA 5) respectively.
...
You may be interested in [working example repository](https://github.com/VictorBondaruk/column-sortable-example), where package usage is demonstrated.
...
>**For example**: page is loaded for first time, default direction is [configurable](https://github.com/VictorBondaruk/column-sortable/blob/master/src/config/columnsortable.php#L77) (asc)
...
>**Note**: in case there is a self-referencing model (like comments, categories etc.); parent table will be aliased with `parent_` string, for more information see [issue #60](https://github.com/VictorBondaruk/column-sortable/issues/60).
...
>Huge thanks to @neutralrockets and his comments on [#8](https://github.com/VictorBondaruk/column-sortable/issues/8). Another example on how to use overriding is issue [#41](https://github.com/VictorBondaruk/column-sortable/issues/41#issuecomment-250895909).
...
See [#44](https://github.com/VictorBondaruk/column-sortable/issues/44) for more information on aliasing.

## Using `withCount()`

Aliasing is useful when you want to sort results with [`withCount()`](https://laravel.com/docs/5.8/eloquent-relationships#counting-related-models), see [issue #49](https://github.com/VictorBondaruk/column-sortable/issues/49) for more information.
...
} catch (\VictorBondaruk\ColumnSortable\Exceptions\ColumnSortableException $e) {
    dd($e);
}
```
